    ...
    <body class="antialiased" id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <header id="header-section">
          ...
          <div class="d-flex justify-content-center">
            <h3 class="font-weight-semibold">Curso diseñado e impartido por:</h3><br><br><br><br>
          </div>
          ...
          <div class="d-flex justify-content-center">
            <address class="d-flex align-items-center mb-6 mx-auto">
              <div class="d-inline-flex align-items-center mr-3 text-sm text-gray-900">
                ...
                <div>
                    <h5 class="font-weight-semibold">Director de Programa Educativo <br> Ingeniería en Tecnología Automotriz</h5><br>

                  <a href="https://www.upq.mx/oferta-academica/ingenieria-en-tecnologia-automotriz/" rel="author" class="text-xl font-weight-bold text-gray-900">Dr. Juan Manuel García Guendulain</a><br><br>
                  <p class="text-base font-weight-light text-gray-500"><time pubdate datetime="2022-02-08" title="February 8th, 2022"> manuel.garcia@upq.edu.mx</time></p>
