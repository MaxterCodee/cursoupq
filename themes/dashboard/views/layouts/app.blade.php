          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="{{ url('admin/exam_category')}}" class="nav-link">
                    <img src="{{ url('assets/images/categoria.svg')}}" alt="" style="width: 12%; height: auto;">
                    <p>Categoría</p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ url('admin/manage_exam')}}" class="nav-link">
                    <img src="{{ url('assets/images/gest.svg')}}" alt="" style="width: 12%; height: auto;">
                    <p>Gestionar exámenes</p>
                </a>
              </li>
              <li class="nav-item">
