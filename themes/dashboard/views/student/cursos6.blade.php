          ...
          <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <!-- Contenedor 2 -->
                  <figure>
                    <img src="/assets/images/ac.png" class="mx-auto d-block" width="90%" height="auto" alt="">
                  </figure>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <!-- Contenedor 1 -->
                  <figure>
                    <img src="/assets/images/movilidad.png" class="mx-auto d-block" width="72%" height="auto" alt="">
                  </figure>
                </div>
                <div class="col-sm-6">
                  <!-- Contenedor 2 -->
                    <br>
                  <p class="lead">En conjunto, estos aliados estratégicos permiten a la Universidad Politécnica de Querétaro mantenerse a la vanguardia en la formación de profesionales altamente capacitados y especializados en diferentes áreas de la tecnología y la ingeniería, lo que contribuye al desarrollo económico y social del estado de Querétaro y del país en general.                  </p>
