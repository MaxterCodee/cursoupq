...
class AdminController extends Controller
{
    ...
    public function manage_students(){
        ...
        $data['students'] = user_exam::select(['user_exams.*','users.name','users.matricula','oex_exam_masters.title as ex_name','oex_exam_masters.exam_date'])
    ...
    public function add_new_students(Request $request){
        ...
        if($validator->fails()){
            ...
            $std->matricula = $request->matricula;
